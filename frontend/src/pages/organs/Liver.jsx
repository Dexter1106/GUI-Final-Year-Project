                ...
                <Card className="md:p-4" accentColor={result.primary_diagnosis === "Healthy" ? "bg-emerald-500" : "bg-red-500"}>
                  ...
                  <div className="mt-6 border border-slate-200 rounded-xl overflow-hidden bg-slate-50">
                    <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-200 bg-white">
                      <div className="p-1.5 bg-teal-100 rounded-lg text-teal-600"><FileBarChart2 size={14} /></div>
                      <div>
                        <p className="text-[0.7rem] font-bold text-slate-800 uppercase tracking-tight">Model Performance Analysis</p>
                        <p className="text-[0.65rem] text-slate-500">Accuracy · Macro Recall · Macro F1 — ILPD Liver Disease Classification across all sub-models</p>
                      </div>
                    </div>
                    <div className="p-3">
                      <img
                        src="http://127.0.0.1:5000/api/plots/liver.png"
                        alt="Liver Model Performance Graph"
